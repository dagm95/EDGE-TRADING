...
<head>
    ...
    <style>.sidebar a.active{background:#0d6efd;color:#fff}</style>
    <script>
    ...
    <link rel="stylesheet" href="admin managment.css">
    <script src="admin managment.js" defer></script>
    <style>
      .sidebar{width:240px;background:#f8f9fa;min-height:100vh;padding:16px}
      .sidebar a{display:block;padding:10px 12px;border-radius:8px;color:#333;text-decoration:none;margin-bottom:6px}
            ...
            <div class="content">
                ...
                <div class="row g-4 kpi-row">
                    <div class="col-sm-6 col-lg-3">
                        <a href="stores.php" class="text-decoration-none text-reset">
